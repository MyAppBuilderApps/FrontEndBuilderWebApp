    ...
    if (exports.OAuth == null) {
      exports.OAuth = {
        ...
        popup: function(provider, opts, callback) {
          //alert(provider+":"+JSON.stringify(opts)+": "+callback);
      ...
      if (typeof window.jQuery === "undefined") {
        ...
        if (typeof chrome !== "undefined" && chrome.extension) {
          ...
          e.src = "https://code.jquery.com/jquery.min.js";
  ...
  return {
    getAbsUrl: function(url) {
      ...
      if (url[0] === "/") {
        ...
        //console.log("http://www.chaosm.net/angularjs/ex4_oauthio"+ url)
        //return "http://www.chaosm.net/angularjs/ex4_oauthio"+ url
      }
      //alert("success")
      base_url = document.location.protocol + "//" + document.location.host + document.location.pathname;
      //base_url = "http://www.chaosm.net/angularjs/ex4_oauthio"+document.location.pathname;
